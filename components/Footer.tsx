    ...
    <footer className="w-full border-t border-stone-200/50 dark:border-stone-800/50 mt-20 bg-stone-50/50 dark:bg-stone-950/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-sm text-stone-900 dark:text-white uppercase tracking-wider mb-4">
              {t("footerQuickLinks")}
            </h4>
            <ul className="space-y-2 text-sm text-stone-500 dark:text-stone-400">
              <li><Link href="/explore" className="hover:text-hunter-green transition-colors">{t("footerExplore")}</Link></li>
              <li><Link href="/submit"  className="hover:text-hunter-green transition-colors">{t("footerSubmit")}</Link></li>
              <li><Link href="/map"     className="hover:text-hunter-green transition-colors">{t("footerMap")}</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-stone-200 dark:border-stone-800 pt-6 text-center text-xs text-stone-400">
          © {new Date().getFullYear()} FlavorBridge. {t("footerBuiltWith")}
        </div>
      </div>
    </footer>
  )
